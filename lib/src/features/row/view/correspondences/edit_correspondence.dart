...
class EditCorrespondence extends StatefulWidget {
  final CorrespondeceType correspondenceType;
  const EditCorrespondence({super.key, required this.correspondenceType});

  @override
  State<EditCorrespondence> createState() => _EditCorrespondenceState();
}

class _EditCorrespondenceState extends State<EditCorrespondence> {
  ...
  void initState() {
    ...
    switch (widget.correspondenceType) {
      case CorrespondeceType.Attachment:
        colorCode = colorFF7D00;
        break;
      case CorrespondeceType.Call:
        colorCode = color8B5CF6;
        break;
      case CorrespondeceType.Email:
        colorCode = color8B5CF6;
        break;
      default:
    }
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        addFileTypeText(context, widget.correspondenceType.name, colorCode),
                      ],
                    ),
                  ),
                  addVerticalSpace(4),
                        ...
                        StaggeredGrid.count(
                          ...
                          children: [
                            ...
                            DropDownList.selected(
                              ...
                              hint: typeHint,
                              onChanged: (p0) {},
                              selectedValue: widget.correspondenceType.name,
                            ),
                          ],
                        ),
                        addVerticalSpace(8),

                        // Show Time, Date and Call
                        StaggeredGrid.count(
                          crossAxisCount: deviceType == DeviceType.Phone ? 1 : 3,
                          mainAxisSpacing: 16,
                          crossAxisSpacing: 16,
                          children: [
                            ...
                            // Show Call Dropdown
                            if (widget.correspondenceType == CorrespondeceType.Call)
                              DropDownList(
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            StaggeredGrid.count(
                              ...
                              children: audioList
                                  .map(
                                    (audioFile) => DocumentCard.addAudio(
                                      document: audioFile,
                                      onDeletePressed: () {
                                        setState(() {
